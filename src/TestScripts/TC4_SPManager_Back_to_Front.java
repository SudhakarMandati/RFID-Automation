...
public class TC4_SPManager_Back_to_Front {
	...
	public TC4_SPManager_Back_to_Front()throws Exception{
...
//    	gs.writePassLog(gs.getText("//*[@id='B2FGridWrapper']/div/div[1]/a"));
        ...
        if(rs.failcounter>0){        	
        	CustomReporter.startParent("SPManager Back to Front", "Verifying store selection");
