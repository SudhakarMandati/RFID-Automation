...
public class TC2_SPManager_Division_Selection {
	...
	public TC2_SPManager_Division_Selection()throws Exception{
     ...
     public void TC2_SPManager_Access()throws Exception{
        ...
        if(rs.failcounter>0){        	
        	CustomReporter.startParent("SPManager Division Selection", "Verifying division selection");
